sap.ui.define([
  ...
  "sap/m/MessageToast",
  "sap/m/MessageBox",
  "BridgeManagementV2/adminbridges/ext/controller/CaptureCondition",
  "BridgeManagementV2/adminbridges/ext/controller/RiskAssessmentsExt"
  ...
  return {
    ...
    onAfterRendering: function () {
      ...
      sap.ui.require(
        ["BridgeManagementV2/adminbridges/ext/controller/CustomAttributesInit"],
        function (CAInit) {
          if (CAInit && typeof CAInit.onContextChange === "function") CAInit.onContextChange();
        }
      );
      sap.ui.require(
        ["BridgeManagementV2/adminbridges/ext/controller/Attachments"],
        function (Att) {
