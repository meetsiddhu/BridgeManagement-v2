sap.ui.define([
  ...
  return Controller.extend("BridgeManagementV2.reports.controller.Main", {
    ...
    onRefresh: function () {
      ...
      model.setProperty("/" + key + "/loaded", false);
      this._loadTab(key);
    ...
    onBridgeRowPress: function (oEvent) {
      ...
      if (id) window.location.href = "#Bridges-manage&/AdminBridges(" + id + ")";
    },
    ...
    _loadTab: function (key) {
      ...
      const state = this.byId("stateFilter") ? this.byId("stateFilter").getSelectedKey() : "";
