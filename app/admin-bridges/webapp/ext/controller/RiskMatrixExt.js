sap.ui.define([
    ...
    for (var l = 5; l >= 1; l--) {
      ...
      for (var col = 1; col <= 5; col++) {
        ...
        html.push(
          ...
          "var ctl=sap.ui.getCore().byId('BridgeManagementV2.adminbridges::BridgeRiskAssessmentsObjectPage--fe::CustomSubSection::riskMatrixSubSection--riskMatrixDialog');",
  ...
  return {
    ...
    _openMatrix: function (matrixType, oEvent) {
      ...
      Fragment.load({
        id:         "riskMatrixFrag",
        name:       "BridgeManagementV2.adminbridges.ext.view.RiskMatrix",
        controller: oSelf
      }).then(function (oFrag) {
        _oDialog = oFrag;
        _oDialog.setModel(oMatrixModel, "matrix");
